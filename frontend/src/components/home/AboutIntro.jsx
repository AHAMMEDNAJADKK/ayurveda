...
const LINES = [
  ...
  { type: 'spacer' },
  { type: 'body', text: 'Welcome to Samedha Ayurvedics, widely recognised as one of' },
  { type: 'body', text: 'the finest Ayurvedic clinics in Kerala for women\'s holistic wellness.' },
  ...
  { type: 'body', text: 'destination for women across all life stages —' },
  { type: 'body', text: 'nurturing strength, hormonal balance, and vitality.' },
